import '../all_tracker_screen/widgets/userprofilelist_item_widget.dart';
...
class AddSugarModal extends StatefulWidget{
   const AddSugarModal({Key? key}) : super(key: key);

  @override
  _AddSugarModal createState() => _AddSugarModal();
}

class _AddSugarModal extends State<AddSugarModal>{
...
Future<void> _selectDate(BuildContext context) async {
  ...
  Widget _showaModal(BuildContext context) {
